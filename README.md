![ARISE Banner](https://arise-middleware.eu/wp-content/uploads/2024/03/logo-arise.png)&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
...
In Grafana the PostgreSQL Datasource is configured using the  datasources.yaml file in ...arise-poc\conf\grafana\datasources 
...
![alt text](https://github.com/Engineering-Research-and-Development/arise-poc/blob/main/docs/images/ARISE_PoC_Grafana_Dashboard_Example.png?raw=true)
...
Docker Compose can be downloaded here [docker-compose.yaml](../docker/docker-compose.yml):
